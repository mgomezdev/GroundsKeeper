export default {
  ...
  printers: {
    ...
    selectPrinterType: 'Selecionar marca da impressora',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Grupos LDAP são mapeados para grupos GroundsKeeper no login',
      ...
      autoProvisionHint: 'Criar automaticamente uma conta GroundsKeeper no primeiro login LDAP',
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos GroundsKeeper. Grupos disponíveis: ',
    ...
    authDisabledMessage: 'Ative a autenticação para criar contas de usuário, gerenciar permissões e proteger sua instância do GroundsKeeper.',
    ...
    disableAuthenticationMessage: 'Tem certeza de que deseja desativar a autenticação? Isso tornará sua instância do GroundsKeeper acessível sem login. Todos os usuários permanecerão no banco de dados, mas a autenticação será desativada.',
    disableAuthentication: 'Desativar Autenticação',
    // Additional settings
    configureGroundsKeeper: 'Configurar GroundsKeeper',
    ...
    bambuddySoftware: 'Software GroundsKeeper',
    ...
    updateViaHomeAssistant: 'As atualizações são gerenciadas pelo Supervisor do Home Assistant. Abra Configurações → Complementos → GroundsKeeper no Home Assistant para instalar a nova versão.',
    ...
    externalUrlDescription: 'A URL externa onde o GroundsKeeper está acessível. Usada para imagens de notificação e integrações externas.',
    bambuddyUrl: 'URL do GroundsKeeper',
    ...
    mqttDescription: 'Publique eventos do GroundsKeeper para um broker MQTT externo para integração com Node-RED, Home Assistant e outros sistemas de automação.',
    ...
    encryption: {
      ...
      migrationErrorWarning: '{{count}} linha(s) antiga(s) não puderam ser recriptografadas na inicialização. Verifique os logs do servidor e reinicie o GroundsKeeper para tentar novamente.',
    },
  ...
  login: {
    ...
    resetStep1: 'Entre em contato com o administrador do GroundsKeeper',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos gerado para o GroundsKeeper.',
  ...
  // Setup page
  setup: {
    title: 'GroundsKeeper Configuração',
    subtitle: 'Configure a autenticação para sua instância do GroundsKeeper',
  ...
  users: {
    ...
    subtitle: 'Gerenciar usuários e seu acesso à sua instância do GroundsKeeper',
    backToSettings: 'Voltar para Configurações',
    createUser: 'Criar Usuário',
    noPermission: 'Você não tem permissão para acessar esta página.',
    admin: 'Admin',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'O GroundsKeeper é servido via HTTPS (pelo seu reverse proxy), mas a URL do Spoolman ainda é HTTP. Os navegadores bloqueiam conteúdo misto por segurança, então a interface embutida do Spoolman não consegue carregar. O Spoolman também precisa estar acessível via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Coloque o Spoolman atrás do mesmo reverse proxy do GroundsKeeper (Traefik / Nginx / Caddy) com HTTPS e atualize a URL do Spoolman em Configurações com o novo endereço HTTPS.',
  ...
  backup: {
    ...
    appSettingsDescription: 'Configuração do GroundsKeeper (banco de dados completo)',
    ...
    localBackupDescription: 'Crie um backup completo dos seus dados do GroundsKeeper incluindo banco de dados, arquivos, uploads e todos os ficheiros.',
    ...
    backupRestoredRestart: 'Backup restaurado. Por favor, reinicie o GroundsKeeper.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'As notas são salvas no GroundsKeeper, não na impressora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visível como "GroundsKeeper" na descoberta do slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Substitua o endereço IP anunciado via SSDP e usado no certificado TLS. Útil quando o GroundsKeeper possui várias interfaces de rede.',
    },
    mode: {
      title: 'Modo',
      archive: 'Arquivar',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL do backend GroundsKeeper',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Cole uma URL de modelo do MakerWorld para importar e imprimir diretamente do GroundsKeeper — sem precisar abrir o app Bambu Handy.',
    ...
    disclaimer: 'A integração com o MakerWorld usa endpoints de API documentados pela comunidade. GroundsKeeper não é afiliado nem endossado pelo MakerWorld ou pela Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Files in external (linked) folders are skipped — GroundsKeeper never deletes bytes it does not own.',    previewLoading: 'Verificando quantos arquivos correspondem…',
