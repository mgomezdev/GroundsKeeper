export default {
  ...
  printers: {
    ...
    selectPrinterType: 'Select your printer brand',
    ...
    toast: {
      ...
      loadInitiated: 'Loading filamentâ€¦',
      unloadInitiated: 'Unloading filamentâ€¦',
    ...
    bedJog: {
      ...
      notHomedMessage: 'The printer has not been homed since the last print. Run auto-home first for safe positioning (parks the toolhead, then homes X, Y, and Z), or move anyway â€” soft endstops will be bypassed.',
      homeZ: 'Auto Home',
      moveAnyway: 'Move anyway',
      homingStarted: 'Auto-homing printerâ€¦',
    },
    // Permissions
    permission: {
    ...
    // Firmware
    firmwareUpdateAvailable: 'Firmware update available: {{current}} â†’ {{latest}}',
    firmwareUpToDate: 'Firmware {{version}} â€” Up to date',
  ...
  archives: {
    ...
    menu: {
      ...
      searchProjects: 'Search projectsâ€¦',
      select: 'Select',
      deselect: 'Deselect',
      delete: 'Delete',
    },
    ...
    card: {
      ...
      noFileForReprint: 'No 3MF file available â€” the file could not be downloaded from the printer when the print was recorded',
  ...
  queue: {
    ...
    sjf: {
      label: 'SJF',
      tooltip: 'Shortest Job First â€” scheduler prioritizes shorter prints',
    },
    addedBy: 'Added by {{name}}',
    nextInQueue: 'Next in queue',
    clearPlateSuccess: 'Plate cleared â€” ready for next print',
    plateNumber: 'Plate {{index}}',
    // Batch / quantity
    quantity: 'Quantity',
  ...
  backgroundDispatch: {
    ...
    progressSummary: '{{complete}}/{{total}} complete â€¢ Dispatched: {{dispatched}} â€¢ Processing: {{processing}}',
    ...
    awaitingPrinter: 'Awaiting printerâ€¦',
    status: {
  ...
  settings: {
    ...
    spoolbuddy: {
      ...
      duplicatesBody: 'Only the first registered device is used by the kiosk UI. If one of these is a stale duplicate from a crash, unregister it â€” an online device will re-register itself on its next heartbeat.',
    ...
    ldap: {
      ...
      feature3: 'LDAP groups are mapped to GroundsKeeper groups on login',
      ...
      autoProvisionHint: 'Automatically create a GroundsKeeper account on first LDAP login',
      defaultGroup: 'Default group',
      defaultGroupNone: 'â€” None (no fallback) â€”',
      ...
      groupMappingHint: 'Map LDAP group DNs to GroundsKeeper groups. Available groups: ',
    ...
    authDisabledMessage: 'Enable authentication to create user accounts, manage permissions, and secure your GroundsKeeper instance.',
    ...
    disableAuthenticationMessage: 'Are you sure you want to disable authentication? This will make your GroundsKeeper instance accessible without login. All users will remain in the database but authentication will be disabled.',
    disableAuthentication: 'Disable Authentication',
    // Additional settings
    configureGroundsKeeper: 'Configure GroundsKeeper',
    ...
    orcaslicerKnownIssuesWarning: 'OrcaSlicer 2.3.2 / 2.4.0-dev have known CLI bugs that block slicing many Bambu-authored 3MFs â€” see upstream issues #12426 (segfault on painted multi-extruder files) and #13386 (parameter-range strict-validation reject). Bambu Studio is recommended until the upstream fixes land.',
    ...
    slicerBundles: {
      ...
      description: 'Import a Printer Preset Bundle (.bbscfg) exported from BambuStudio (File â†’ Export â†’ Export Preset Bundle â†’ "Printer preset bundle"). Once imported, slice requests can pick presets from the bundle by name without re-uploading the JSON profile triplet.',
      uploadButton: 'Upload bundle',
      uploading: 'Uploadingâ€¦',
      loading: 'Loading bundlesâ€¦',
      empty: 'No bundles imported yet.',
      summary: '{{processCount}} process Â· {{filamentCount}} filament presets',
      delete: 'Delete',
    ...
    cameraSnapshotUrlHelp: 'Single-frame URL used for notification thumbnails, finish photos, layer-timelapse frames, and plate detection. Timelapse and plate detection each require their own per-printer toggle â€” this URL is just the image source they pull from when active. Leave blank to capture from the live stream above. Useful for go2rtc (/api/frame.jpeg) and IP cameras with a dedicated snapshot endpoint.',
    ...
    updateViaHomeAssistant: 'Updates are managed by the Home Assistant Supervisor. Open Settings â†’ Add-ons â†’ GroundsKeeper in Home Assistant to install the new version.',
    ...
    externalUrlDescription: 'The external URL where GroundsKeeper is accessible. Used for notification images and external integrations.',
    ...
    haTokenHint: 'Create a token in HA: Profile â†’ Long-Lived Access Tokens â†’ Create Token',
    ...
    mqttDescription: 'Publish GroundsKeeper events to an external MQTT broker for integration with Node-RED, Home Assistant, and other automation systems.',
    ...
    twoFa: {
      ...
      scannedContinue: 'I\'ve scanned the code â€” continue',
    ...
    encryption: {
      ...
      legacyRowsWarning: '{{count}} legacy plaintext row(s) detected. Re-save the OIDC provider or re-enroll the userâ€™s authenticator app to migrate to encrypted storage.',
      ...
      migrationErrorWarning: '{{count}} legacy row(s) failed to re-encrypt at startup. Check server logs and restart GroundsKeeper to retry.',
    },
  ...
  login: {
    ...
    oidcErrors: {
      ...
      stateExpired: 'OIDC login session expired â€” please try again',
      ...
      nonceMismatch: 'OIDC nonce mismatch â€” possible replay attack',
    ...
    resetStep1: 'Contact your GroundsKeeper administrator',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Open your authenticator app and enter the 6-digit code for GroundsKeeper.',
  ...
  // Setup page
  setup: {
    title: 'GroundsKeeper Setup',
    subtitle: 'Configure authentication for your GroundsKeeper instance',
  ...
  users: {
    ...
    subtitle: 'Manage users and their access to your GroundsKeeper instance',
    backToSettings: 'Back to Settings',
    createUser: 'Create User',
    noPermission: 'You do not have permission to access this page.',
    admin: 'Admin',
  ...
  fileManager: {
    ...
    linkExternalFolderDescription: 'Mount a host directory (NAS, USB, network share) into the File Manager. Files are not copied â€” they are accessed directly from the original path.',
  ...
  slice: {
    ...
    selectPreset: 'â€” Select a preset â€”',
    loadingPresets: 'Loading presetsâ€¦',
    analyzingPlateFilaments: 'Analyzing plate filamentsâ€¦',
    analyzingPlateFilamentsHint: 'Running a preview slice to discover which AMS slots this plate uses. Cached after â€” re-opening is instant.',
    previewToast: 'Analyzing {{name}} â€” {{elapsed}}',
    previewWithProgress: 'Analyzing {{name}} â€” {{stage}} ({{percent}}%) â€” {{elapsed}}',
    notUsedByPlate: 'â€” not used by this plate',
    printerMismatch: 'This 3MF was sliced for {{source}}, but you picked {{target}}. The slicer CLI cannot re-slice a 3MF for a different printer â€” open the source in OrcaSlicer or BambuStudio, switch to the correct printer, and re-export.',
    noPresetsForSlot: 'No presets available',
    presetsLoadFailed: 'Failed to load presets. Open Settings â†’ Profiles to import them first.',
    allPresetsRequired: 'All presets must be selected',
    enqueuing: 'Submitting slice jobâ€¦',
    queued: 'Queuedâ€¦',
    failed: 'Slicing failed. Check the slicer sidecar logs.',
    startedToast: 'Slicing {{name}} in the backgroundâ€¦',
    queuedToast: 'Queued: {{name}} â€” {{elapsed}}',
    runningToast: 'Slicing {{name}} â€” {{elapsed}}',
    ...
    cloud: {
      notAuthenticated: 'Sign in to Bambu Cloud (Settings â†’ Profiles â†’ Cloud) to see your cloud presets.',
      expired: 'Bambu Cloud session expired â€” sign in again to refresh your cloud presets.',
  ...
  inventory: {
    ...
    spoolmanMixedContentTitle: 'Spoolman can\'t load over HTTPS â€” mixed-content blocked by your browser',
    spoolmanMixedContentBody: 'GroundsKeeper is served over HTTPS (via your reverse proxy), but your Spoolman URL is still plain HTTP. Browsers block mixed content for security, so the embedded Spoolman UI can\'t render. Spoolman needs to be reachable over HTTPS for this to work.',
    spoolmanMixedContentFixReverseProxy: 'Put Spoolman behind the same reverse proxy as GroundsKeeper (Traefik / Nginx / Caddy) with HTTPS, then update the Spoolman URL in Settings to the new HTTPS address.',
    spoolmanMixedContentFixOpenNewTab: 'As a workaround, open Spoolman in a new browser tab over HTTP â€” mixed-content rules only apply to embedded frames, so a standalone tab still works.',
    ...
    // RFID button rename (was "Delete Tag" â€” confusing because it sounds like a
    ...
    deepLinkFetchFailed: 'Could not load spool â€” try again',
    spoolArchived: 'Spool archived',
    spoolRestored: 'Spool restored',
    kProfileSaveFailed: 'K-profile settings could not be saved',
    syncWeightSpoolNotFound: 'Spool not found â€” it may have been deleted',
    syncWeightSpoolmanUnreachable: 'Spoolman is unreachable â€” try again later',
    syncWeightFailed: 'Failed to sync weight',
    spoolmanUnreachable: 'Spoolman is not reachable â€” please try again later',
    deleteSpoolNotFound: 'Spool not found â€” it may have already been deleted',
    deleteFailed: 'Failed to delete spool',
    archiveSpoolNotFound: 'Spool not found â€” it may have already been deleted',
    archiveFailed: 'Failed to archive spool',
    restoreSpoolNotFound: 'Spool not found â€” it may have already been deleted',
    ...
    pickFromSpoolmanCatalog: 'Pick from Spoolman catalogâ€¦',
  ...
  // Backup
  backup: {
    includesEncryptionKey: 'Local backups include the MFA encryption key file (DATA_DIR/.mfa_encryption_key) so a backup ZIP is self-contained. Treat the ZIP as sensitive â€” anyone with the file can decrypt the OIDC client secrets and TOTP secrets stored inside.',
    ...
    enabled: 'Enabled',
    cloudLoginRequired: 'Bambu Cloud login required. Sign in under Profiles â†’ Cloud Profiles to enable GitHub backup.',
    ...
    appSettingsDescription: 'GroundsKeeper configuration (complete database)',
    ...
    localBackupDescription: 'Create a complete backup of your GroundsKeeper data including the database, archives, uploads, and all files.',
    ...
    backupRestoredRestart: 'Backup restored. Please restart GroundsKeeper.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notes are saved in GroundsKeeper, not on the printer',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible as "GroundsKeeper" in slicer discovery',
    ...
    remoteInterface: {
      ...
      hint: 'Override the IP address advertised via SSDP and used in the TLS certificate. Useful when GroundsKeeper has multiple network interfaces.',
    },
    mode: {
      title: 'Mode',
      archive: 'Archive',
    ...
    queueForceColorMatch: {
      ...
      description: 'Refuse to dispatch onto a printer that does not have the exact filament type and color loaded. Off by default â€” without this, the queue uses model-only matching and may pick a printer with the wrong color loaded.',
    },
    tailscaleDisabled: {
      title: 'Tailscale integration',
      description: 'Enable to mark this VP as exposed over Tailscale. Shows the host\'s Tailscale address so you know which IP to paste into the slicer. The CA-import step is unchanged â€” this toggle has no effect on certificates.',
    },
    setupRequired: {
    ...
    archiveNameSource: {
      ...
      description: 'Choose how new archives are named when files arrive via the virtual printer. "Metadata" uses the slicer-embedded title from the 3MF (default). "Filename" uses the filename Bambu Studio sent over FTP â€” handy if you renamed the job in the "send to printer" dialog.',
      metadata: 'Metadata',
      filename: 'Filename',
    },
    howItWorks: {
      ...
      step2: 'In Archive, Review, and Queue modes, use the "Send" button in your slicer to upload 3MF files to GroundsKeeper. The slicer will show "Print success" â€” the file is stored, not printed.',
      step3: 'In Proxy mode, the virtual printer relays all traffic to a real printer â€” prints start immediately as if connected directly.',
    },
    status: {
    ...
    toast: {
      ...
      copyFailed: 'Failed to copy â€” try selecting the text manually',
  ...
  smartPlugs: {
    ...
    haSettingsPath: 'Settings â†’ Network â†’ Home Assistant',
    ...
    mqttSettingsPath: 'Settings â†’ Network â†’ MQTT Publishing',
  ...
  spoolbuddy: {
    ...
    writeTag: {
      ...
      tagReady: 'Tag detected â€” ready to write',
      writeTag: 'Write Tag',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Paste a MakerWorld model URL to import and print it directly from GroundsKeeper â€” without leaving for the Bambu Handy app.',
    pasteUrlHeader: 'Import from MakerWorld',
    pasteUrlPlaceholder: 'https://makerworld.com/en/models/â€¦ or paste any MakerWorld link',
    ...
    alreadyInLibrary: 'This model is already in your library â€” find it in File Manager â†’ MakerWorld',
    importSuccess: 'Imported {{filename}} â€” saved to File Manager â†’ MakerWorld',
    ...
    disclaimer: 'MakerWorld integration uses community-documented API endpoints. GroundsKeeper is not affiliated with or endorsed by MakerWorld or Bambu Lab.',
  ...
  libraryTrash: {
    ...
    loading: 'Loading trashâ€¦',
    loadError: 'Could not load the trash.',
    empty: 'The trash is empty.',
    summary: '{{count}} files Â· {{size}}',
  ...
  libraryPurge: {
    ...
    effect1: 'Matching files are moved to Trash â€” they are not deleted from disk yet.',
    ...
    effect4: 'Files in external (linked) folders are skipped â€” GroundsKeeper never deletes bytes it does not own.',
    previewLoading: 'Checking how many files matchâ€¦',
    previewFailed: 'Could not preview the purge.',
    previewSummary: '{{count}} files Â· {{size}} would move to trash',
    andMore: 'â€¦and {{count}} more',
  ...
  libraryAutoPurge: {
    ...
    enableDescription: 'Runs the admin purge once per day. Files go to Trash first â€” they are not deleted immediately.',
  ...
  archivePurge: {
    ...
    description: 'Clear out old print history. Each archive is aged by its most recent print completion â€” reprinting an archive refreshes its age, so active work is never purged.',
    ...
    effect3: 'There is no trash bin for archives â€” deletion is immediate and cannot be undone.',
    effect4: 'Reprinting an archive refreshes its age clock, so archives you still use are safe.',
    previewLoading: 'Checking how many archives matchâ€¦',
    previewFailed: 'Could not preview the purge.',
    previewSummary: '{{count}} archives Â· {{size}} would be deleted',
    andMore: 'â€¦and {{count}} more',
  ...
  archiveAutoPurge: {
    ...
    enableDescription: 'Once per day, permanently deletes archives that have not been printed within the threshold. Reprinting an archive resets the clock. No trash bin â€” deletion is immediate.',
    ageLabel: 'Auto-delete archives not printed in the last',
    ageDescription: 'Minimum 7 days, maximum 10 years. Based on the most recent print completion â€” reprinting an archive refreshes its age. Deletes the archive, 3MF, thumbnail, timelapse, and photos.',
    days: 'days',
  ...
  forecast: {
    ...
    noUsageData: 'No usage data available â€” cannot project stock timeline.',
    // Table headers
    sku: 'SKU',
    material: 'Material',
    stock: 'Stock',
    ...
    timeframe: 'Timeframe',
    // Chart
    chartTitle: 'Projected Stock â€” Top 5 Materials',
    ...
    globalLeadTimeHint: 'Global lead time floor â€” used in reorder point calculation for all SKUs',
    ...
    reorderPointHint: 'dÌ„ Ã— LT + safety margin â€” order when stock hits this level',
    safetyMarginHint: 'Statistical safety stock (z=1.65 Ã— Ïƒ Ã— âˆšLT) + user-defined buffer',
    safetyMarginHintDays: 'Buffer added on top of statistical safety stock.{{approx}}',
    safetyMarginHintDaysApprox: ' â‰ˆ {{g}}g at current rate.',
    safetyMarginHintG: 'Fixed weight buffer added on top of statistical safety stock.{{approx}}',
    safetyMarginHintGApprox: ' â‰ˆ {{days}}d at current rate.',
    ...
    markReceived: 'Mark as received â€” adds spools to Stock inventory',
    ...
    noUsageQty: 'No usage data â€” quantity set to 1.',
    noteOptional: 'Note (optional)',
    notePlaceholder: 'e.g. for project X, urgentâ€¦',
